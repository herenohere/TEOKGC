...
parser.add_argument('--pos-batch', default=0, type=int,
                    help='number of pre-batch used for negatives')
parser.add_argument('--pos-batch-weight', default=0.5, type=float,
                    help='the weight for logits from pre-batch negatives')
...
parser.add_argument('--p-weight', default=None, type=float)

parser.add_argument('--head-num', default=1, type=int)

parser.add_argument('--deformable-points', default=1, type=int)

parser.add_argument('--p-weight', default=None, type=int)
